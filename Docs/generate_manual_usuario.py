...
def get_role_screens(profile_name):
    common_pages = [
        ...
        },
        {
            ...
            "bullets": [
                ...
                "Los auxiliares ven el menú 'Administración' con accesos a Dashboard, Pedidos, Categorías, Subcategorías, Productos y Soporte, pero con permisos limitados.",
                "Los administradores ven además accesos a Usuarios y Cotizaciones para cubrir funciones de gestión completa.",
    ...
    auxiliar_pages = [
        *client_pages,
        {
            "title": "Dashboard administrativo (auxiliar)",
            "description": "El dashboard del auxiliar ofrece una vista general de las operaciones clave del negocio y accesos rápidos a tareas de apoyo, sin incluir funciones de administración completa.",
            "bullets": [
                "Botón 'Actualizar datos' para refrescar métricas y números de estado.",
                "Tarjetas de KPI centradas en pedidos, catálogo y soporte, con enfoque operativo.",
                "Accesos directos para revisar pedidos, mantener categorías y productos básicos, y atender tickets.",
                "No incluye gestión de usuarios ni cotizaciones; esas funciones quedan reservadas al administrador.",
            ],
        },
        {
            "title": "Gestión de pedidos (auxiliar)",
            "description": "Permite revisar los pedidos, aplicar filtros y cambiar su estado desde una vista centralizada, dentro del alcance del rol de apoyo.",
            "bullets": [
                ...
                "Botón 'Ver detalle' para abrir la información completa del pedido y sus productos.",
                "Botones en cada fila para cambiar el estado: 'En Proceso', 'Cancelar', 'Enviar' o 'Entregar', según el estado actual.",
                "Se limita a seguimiento y actualización de estado; no puede eliminar pedidos ni administrar usuarios asociados.",
            ],
        },
        {
            "title": "Gestión limitada de categorías",
            "description": "La sección de categorías permite al auxiliar mantener el catálogo básico con permisos restringidos.",
            "bullets": [
                "Botón 'Nueva Categoría' para abrir el modal de creación.",
                "Botones 'Editar' para modificar nombre, descripción y estado.",
                "Botón 'Activar' o 'Desactivar' para cambiar la disponibilidad de la categoría.",
                "No se permite eliminar categorías; esa acción es exclusiva del administrador.",
                "Los filtros de búsqueda y estado ayudan a localizar categorías de forma rápida.",
            ],
        },
        {
            "title": "Gestión limitada de subcategorías",
            "description": "La gestión de subcategorías permite apoyar la organización del catálogo, sin acceso a operaciones críticas.",
            "bullets": [
                ...
                "Botón 'Activar' o 'Desactivar' para cambiar el estado de la subcategoría.",
                "No se permite eliminar subcategorías; esa tarea queda reservada al administrador.",
                "Se pueden aplicar filtros por categoría y estado para encontrar registros fácilmente.",
            ],
        },
        {
            "title": "Gestión limitada de productos",
            "description": "La sección de productos permite al auxiliar actualizar información básica y disponibilidad del catálogo, sin permisos completos de administración.",
            "bullets": [
                "Botón 'Nuevo Producto' para abrir el modal de creación.",
                "Filtros por búsqueda, categoría, subcategoría y rango de precio.",
                ...
                "No se permite eliminar productos; esa acción solo la realiza el administrador.",
                "La gestión está enfocada en mantener actualizado el inventario y el catálogo básico.",
            ],
        },
        {
            "title": "Soporte y atención",
            "description": "La sección de soporte permite revisar mensajes recibidos y responderlos desde la plataforma, dentro del alcance del rol de apoyo.",
            "bullets": [
                ...
                "El auxiliar no gestiona usuarios ni cotizaciones; solo apoya la atención de soporte operativa.",
            ],
        },
    ]
    ...
    administrador_pages = [
        *auxiliar_pages,
        {
            "title": "Dashboard administrativo (administrador)",
            "description": "El dashboard del administrador ofrece métricas completas y accesos a las secciones de gestión total del sistema.",
            "bullets": [
                "Botón 'Actualizar datos' para refrescar métricas y números de estado.",
                ...
                "Acciones rápidas disponibles para Nuevo Producto, Nueva Categoría, Subcategorías, Gestionar Pedidos, Usuarios y Cotizaciones.",
            ],
        },
        {
...
def build_profile_manual(profile_name, role_label, role_description, focus_points, faq_items):
    ...
    add_section(doc, "2.1 Mapa del sistema", bullets=[
        ...
        "Módulo administrativo: menú de administración con accesos a Dashboard, Categorías, Subcategorías, Productos, Pedidos y Soporte para auxiliares, y además Usuarios y Cotizaciones para administradores.",
    ], level=2)
    ...
    add_section(doc, "5. Navegación por la interfaz", bullets=[
        ...
        "Los auxiliares ven el menú 'Administración' con accesos a Dashboard, Pedidos, Categorías, Subcategorías, Productos y Soporte, con permisos limitados.",
    ...
    add_table(doc, ["Rol", "Qué puede hacer", "Por qué tiene esa limitación"], [
        ...
        ("Administrador", "Gestionar productos, categorías, usuarios, pedidos, cotizaciones y soporte", "Es el rol con mayor responsabilidad y control del sistema"),
...
profiles = [
    ...
    },
    {
        "name": "Auxiliar",
        "role_label": "auxiliar",
        "role_description": "El auxiliar apoya la operación de la tienda con permisos limitados: puede revisar pedidos, mantener el catálogo básico y atender soporte, pero no gestiona usuarios ni elimina registros.",
        "focus_points": [
            "Puede revisar pedidos, crear o editar categorías, subcategorías y productos, y responder tickets de soporte.",
            "Debe evitar eliminar registros, modificar usuarios o cambiar roles sin autorización del administrador.",
            "Su función es apoyar operaciones diarias, no asumir la administración completa del sistema.",
        ],
        "faq_items": [
            ("¿Qué tareas puede hacer un auxiliar?", "Puede revisar y actualizar pedidos, mantener el catálogo básico y atender soporte, pero no eliminar ni administrar usuarios."),
            ("¿Puede modificar productos?", "Sí, dentro del alcance limitado del rol, pero no puede eliminarlos ni gestionar usuarios o cotizaciones."),
