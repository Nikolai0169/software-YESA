...
const AdminSubcategoriasPage = () => {
  ...
  const subcategoriasFiltradasYOrdenadas = useMemo(() => {
    let resultado = subcategorias.filter(sub => {
      ...
      if (filtros.categoriaId !== 'todas' && sub.categoriaId !== Number.parseInt(filtros.categoriaId)) return false;
          ...
          <Dropdown as={ButtonGroup} className="me-2">
            ...
            <Dropdown.Menu>
              <Dropdown.Item
                ...
                data-format="pdf"
                onClick={() => { setTipoExportacion('pdf'); exportarSubcategoriasAPDF(subcategoriasFiltradasYOrdenadas, categorias); }}
              >
              ...
              <Dropdown.Item
                ...
                data-format="excel"
                onClick={async () => { setTipoExportacion('excel'); await exportarSubcategoriasAExcel(subcategoriasFiltradasYOrdenadas, categorias); }}
              >
