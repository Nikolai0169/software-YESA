/**
 * Este archivo es la gestion de usuarios para el panel de administrador
 * lista todos los usuarios del sistema con eel nombre, email, rol y estado
 * permite buscar usuarios por texto y navegar entre paginas 10 por pagina
 * solo administrador puede activar/ desactivar y eliminar usuarios
...
type Usuario = {
    ...
    apellido?: string;
    email?: string;
    rol?: string; //administradoir/auxiliar/cliente
...
export default function AdminUsuariosScreen() {
    ...
    const handlePagina = (next: number) => {
        ...
        fetchUsuarios(nueva, busqueda); //conserva el filtro de busqueda al cambiar de página
    };
