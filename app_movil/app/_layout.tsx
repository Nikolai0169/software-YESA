...
// ── IMPORTACIONES ────────────────────────────────────────────────────────────
import { DarkTheme, DefaultTheme } from '@react-navigation/native'; // Temas claro/oscuro.
    ...
    <AuthProvider>
      ...
      <CarritoProvider>
          <>
            ...
            <Stack.Screen name="admin/productos-form" options={{ title: 'Crear/Editar Producto' }} />
