...
// NOTE: helpers that call `router` are created inside the component to avoid
// accessing the router before it's initialized by Expo Router.
...
export default function MisPedidosScreen() {
  // Cast helpers: created inside component to avoid module-level access to `router`.
      ...
      {pedidos.length === 0 ? (
        ...
        <ThemedView style={styles.emptyState}>
          ...
          <Pressable style={styles.primaryButton} onPress={() => routerReplace('/(tabs)/')}>
            <ThemedText style={styles.primaryButtonText}>Ir al Catálogo</ThemedText>
          </Pressable>
        </ThemedView>
      ) : (
