...
// Evita pasar parámetros inesperados (index, array) a la función
// `construirURLProducto` envolviéndola en una arrow function.
const construirURLsProductos = (productos, req) => {
  if (Array.isArray(productos)) {
    return productos.map(p => construirURLProducto(p, req));
  }
